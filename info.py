...
USERNAME = environ.get('USERNAME', "@ganedu")
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002494415407'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002148374926'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002316337794'))
